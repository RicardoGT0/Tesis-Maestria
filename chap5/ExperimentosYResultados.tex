...
En el periodo de aproximadamente 4 meses comprendido del 24/02/2018 al 
 30/06/2018 las personas tuvieron encendida su computadora diferente cantidad 
...
En ambas tablas mencionadas (\ref{tableRes1} y \ref{tableRes2}) se 
 muestra la cantidad de \emph{Secuencias Aceptables} de acuerdo con los 
 criterios mencionados anteriormente y el \emph{Porcentaje de Precisi\'on}
 correspondiente a las \emph{Secuencias Aceptables} respecto al \emph{Total de 
...
En la tabla \ref{tableRes1} cabe destacar que el sujeto \textbf{n\'umero 1}
 ...
 3} y \textbf{n\'umero 4} son los que obtuvieron menos \emph{Secuencias
 Aceptables} y un menor \emph{Porcentaje de Precisi\'on} con un 32.33\% y
...
En la tabla \ref{tableRes2} se observa que el sujeto \textbf{n\'umero 1} es 
 ...
 mientras que el sujeto \textbf{n\'umero 2} es el que tiene la mayor
 \emph{precisi\'on} con el 45.09\%.
